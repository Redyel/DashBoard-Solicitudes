...
aplazamientos = pd.read_excel("./Sabana_Notas_1s.xlsx",engine='openpyxl')
...
ndf = df.assign(demora=0)[['Radicado','Fecha de Radicado','Fecha Seguimiento','Dependencia Seguimiento','demora' ,'Estado Solicitud','Sede de vinculación','Usuario Seguimiento','Estado Seguimiento','Hora']]
...
xndf = ndf[['Radicado','Fecha de Radicado','Fecha Seguimiento','Dependencia Seguimiento','demora','Estado Solicitud','Sede de vinculación','Usuario Seguimiento','Estado Seguimiento','Hora']]
xndf['demora'] = pd.to_timedelta(xndf['demora']).dt.days
print(xndf)
xndf.to_csv('Ok_Sabana_Notas_1s.csv',encoding='latin1')