#Importar las librerias necesarias para el desarrollo
import pandas as pd
import openpyxl
import numpy as np
...
aplazamientos = pd.read_excel("./Aplazamiento_Semestre.xlsx",engine='openpyxl')
...
print(xndf)
xndf.to_csv('Ok_Aplazamiento_Semestre.csv',encoding='latin1')