...
aplazamientos = pd.read_excel("./Traslado_Horario_1vez.xlsx",engine='openpyxl')
...
ndf = df.assign(demora=0)[['Radicado','Fecha de Radicado','Fecha Seguimiento','Dependencia Seguimiento','demora' ,'Estado Solicitud','Sede en la que estudia actualmente','Usuario Seguimiento','Estado Seguimiento','Hora']]
...
xndf = ndf[['Radicado','Fecha de Radicado','Fecha Seguimiento','Dependencia Seguimiento','demora','Estado Solicitud','Sede en la que estudia actualmente','Usuario Seguimiento','Estado Seguimiento','Hora']]
xndf['demora'] = pd.to_timedelta(xndf['demora']).dt.days
print(xndf)
xndf.to_csv('Ok_Traslado_Horario_1vez.csv',encoding='latin1')